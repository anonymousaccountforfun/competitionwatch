  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        feature: "border-transparent bg-blue-100 text-blue-800",
        messaging: "border-transparent bg-green-100 text-green-800",
        pricing: "border-transparent bg-yellow-100 text-yellow-800",
        partnership: "border-transparent bg-purple-100 text-purple-800",
        minor: "border-transparent bg-neutral-100 text-neutral-600",
